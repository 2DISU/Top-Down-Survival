...
public class StartScreen extends JFrame {
    ...
    private String windowTitle = "Afterlife";
    private String windowIconPath = "Resources/Screen Utilities/IconSmall_Zombie.gif";
    private String backgroundImgPath = "Resources/Backgrounds/AfterLife.jpg";
    ...
    private String HighScoreText() throws IOException, ClassNotFoundException {
        ...
        highScoreText = "<html>Welcome to the A F T E R L I F E <br><br>" +
    ...
    private String helpText() {
        String helpText;
        helpText = "<html>Welcome to the A F T E R L I F E <br><br>" +
